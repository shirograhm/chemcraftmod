...
public class VolcanoBlock extends Block {
    protected static final VoxelShape SHAPE = VoxelShapes.or(
            ...
            Block.makeCuboidShape(3.0D, 3.0D, 3.0D, 13.0D, 5.0D, 13.0D),
            Block.makeCuboidShape(4.0D, 5.0D, 4.0D, 12.0D, 7.0D, 12.0D),
            Block.makeCuboidShape(5.0D, 7.0D, 5.0D, 11.0D, 9.0D, 11.0D),
            Block.makeCuboidShape(6.0D, 9.0D, 6.0D, 10.0D, 10.0D, 10.0D),
            Block.makeCuboidShape(7.0D, 10.0D, 7.0D, 9.0D, 11.0D, 9.0D)
    );
